...
**แหล่งข้อมูล**: แหล่งที่มาของข้อมูลจากเว็ปไซต์ของแต่ละปี รวมมาเป็นสี่ปีเป็นไฟล์เดียวชื่อ `AllParkYear.csv` - ข้อมูลการตรวจวัด PM2.5 รายเดือนของสวนสาธารณะในกรุงเทพฯ 
...
- **PM2.5 เฉลี่ย**: ค่าเฉลี่ยของข้อมูลที่เลือก
- **⚠️ ค่าสูงสุด**: ค่า PM2.5 สูงสุดที่วัดได้
- ** วันเกินมาตรฐาน**: จำนวนวันที่เกิน 25 μg/m³
- **จำนวนสถานที่**: จำนวนสถานที่ในข้อมูลที่กรอง
